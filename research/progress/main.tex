...
\subsubsection{The hyperplanes of radial basis activation functions}
...
\subsubsection{The stripe problem without hidden units}
...
The depicted goal configuration can be achieved when $w_1=-1$ and $w_2=1$ which means that only $w_1$ needs to change, but in doing so, some points will be misclassified. 
