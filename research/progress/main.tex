...
\begin{figure}[h]
    ...
    \begin{tikzpicture}
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{The error-weight surface associated with the stripe problem.}
...
\begin{wrapfigure}{R}{0.55\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot[blue] table {../data/week6_stripe_loss.dat};
        \end{axis}
    \end{tikzpicture}
    \caption{Progress of training accuracy.}
    \label{week6:stripe:trainingaccuracy}
\end{wrapfigure}
