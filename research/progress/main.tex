    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot3 [
                ...
                domain=-3:3,
                y domain=-3:3
            ] {(exp(-(2*x)^2))^2 + (exp(-(2*y)^2))^2 + (1 - exp(-(2*x + 2*y)^2))^2};
...
\begin{wrapfigure}{R}{0.55\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_stripe_loss.dat};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h]
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_loss.dat};
        \end{axis}
    \end{tikzpicture}
    \vspace{.05\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_loss_1000.dat};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h]
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_predictions_a.dat};
            \addplot+[mark=none] table {../data/week6_shallow_network_predictions_b.dat};
        \end{axis}
    \end{tikzpicture}
    \vspace{.05\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_predictions.dat};
        \end{axis}
    \end{tikzpicture}
...
\begin{figure}[h]
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_weight_0.dat};
            \addplot+[mark=none] table {../data/week6_shallow_network_weight_1.dat};
        \end{axis}
    \end{tikzpicture}
    \vspace{.05\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=none] table {../data/week6_shallow_network_weights.dat};
        \end{axis}
    \end{tikzpicture}
...
Note that $\vec{\hat{y}_i}$ refers to the prediction of the output at the $i$th iteration (a vector), whereas $y_i$ refers to the output of the $i$th sample (i.e. $f(\vec{x_i})$) and is a scalar.
...
\begin{figure}[h]
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xlabel = {$w_1$},
            ylabel = {$w_2$},
            legend entries = {target, actual},
            legend pos = north west
            ]
            \addplot+[mark=x] table {../data/sem2_week3_stripe_target_weights.dat};
            \addplot+[mark=none] table {../data/sem2_week3_stripe_training_weights.dat};
            \node[pin=180:start] at (1,1) {};
            \node[pin=180:goal] at (1,-1) {};
        \end{axis}
    \end{tikzpicture}
    \vspace{.05\textwidth}
    \begin{tikzpicture}
        \begin{axis}[
            scale only axis,
            width = 0.4\textwidth,
            title = {Output space (for samples 2 and 4)},
            xlabel = {$y_2$},
            ylabel = {$y_4$},
            legend entries = {target, actual},
            legend pos = north east
            ]
            \addplot+[mark=x] table {../data/sem2_week3_stripe_target_outputs.dat};
            \addplot+[mark=none] table {../data/sem2_week3_stripe_training_outputs.dat};
            \node[pin=0:start] at (0,0) {};
            \node[pin=180:goal] at (1,0) {};
        \end{axis}
    \end{tikzpicture}
...
The main idea underlying this technique is that mutually attracting\footnote{\say{attracting} here means moving towards each other} the actual output and the subgoal will lead to a realizable goal-connecting path in output space. 
...
\begin{figure}[h]
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=x] table {../data/sem2_week6_stripe_target_weights.dat};
            \addplot+[mark=none] table {../data/sem2_week6_stripe_training_weights.dat};
            \node[pin=180:start] at (1,1) {};
            \node[pin=180:goal] at (1,-1) {};
        \end{axis}
    \end{tikzpicture}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+[mark=x] table {../data/sem2_week6_stripe_target_outputs.dat};
            \addplot+[mark=none] table {../data/sem2_week6_stripe_training_outputs.dat};
            \node[pin=0:start] at (0,0) {};
            \node[pin=180:goal] at (1,0) {};
        \end{axis}
    \end{tikzpicture}
    \caption{Weight and output spaces.}
    \label{fig:sem2_week6:stripe:weights}
\end{figure}
