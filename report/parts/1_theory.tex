...
\todo: talk about output activation function (sigmoid, probability)
...
\begin{figure}
    ...
    \begin{tikzpicture}[
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Hyperplanes in input space for the stripe problem with eight samples.}
    \label{fig:stripe_original_hyperplanes}
\end{figure}

\todo: General intuition incl input space plot with hyperplanes.
...
\begin{definition}[Radial basis functions]
