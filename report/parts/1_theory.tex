...
It can be used in order to determine whether and to what extent a training regime is \textit{capable} of realising each subgoal.
...
\end{enumerate}
We will employ this technique in \ref{sec:stripe_gradient_descent_subgoals} to evaluate the feasability of the ideal goal line.
\todo{Where else?}
