...
\end{figure}
The greedy probing approach was also tested.
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            symbolic y coords={{gradient descent},{greedy probing (exhaustive sampling)},{greedy probing (modified cost)},{greedy probing (random sampling)}},
            ytick=data,
            nodes near coords,
...
\todo: number of steps vs gradient descent
