...
\begin{lemma}
    A $L$-layered MLP where the number of inputs to layer $l$ is given as $m_l$ will have a total of
...
\begin{proof}
    ...
    \end{figure}
    Modifying the formula for a SLN given in (\ref{eq:single_layer_perceptron}) for the case where there is only one output unit, we obtain
