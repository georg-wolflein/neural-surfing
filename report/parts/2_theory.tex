...
We will design 
follow a more principled approach
\todo
...
\subsection{Setting subgoals}
\label{sec:setting_subgoals}
...
The na\"{i}ve algorithm from \ref{sec:setting_subgoals} proved to be a bottleneck in the pre-computation stage, so a more efficient version of that algorithm was devised.
