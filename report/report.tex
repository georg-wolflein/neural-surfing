...
\begin{figure}[h]
    \begin{center}
        \begin{tikzpicture}
            ...
            \node [neuron] (n1) at (3,1) {};
            \node [neuron] (n2) at (3,-1) {};
            \node [neuron] (n3) at (3,-3) {};
            \node [neuron] (n4) at (3,-5) {};
            \node (b1) at (3, 2) {$b_1$};
            \node (b2) at (3, 0) {$b_2$};
            \node (b3) at (3, -2) {$b_3$};
            \node (b4) at (3, -4) {$b_4$};
            \node (y1) at (6, 1) {$\hat{y}_1$};
            \node (y2) at (6, -1) {$\hat{y}_2$};
            \node (y3) at (6, -3) {$\hat{y}_3$};
            \node (y4) at (6, -5) {$\hat{y}_4$};
            \draw[->] (x1) -- (n1);
            \draw[->] (x1) -- (n2);
            \draw[->] (x1) -- (n3);
            \draw[->] (x1) -- (n4);
            ...
            \draw[dashed] (-1,2.5) rectangle (1,-6);
            \draw[dashed] (5,2.5) rectangle (7,-6);
            \node[above] at (0, 2.5) {Input};
            \node[above] at (6, 2.5) {Output};
        \end{tikzpicture}
    \end{center}
    \caption{A single-layer perceptron with 3 input and 4 output neurons.}
